...
int main()
{
  ...
  std::ifstream stream("/home/kei/document/experiments/2019.06.25/data3/test.csv");
  std::string line;
  ...
  int j = 0;
  FILE *fp;
  fp=fopen("/home/kei/document/experiments/2019.06.25/data3/save.csv","w");
