...
int main()
{
  ...
  std::ifstream stream("/home/kei/document/experiments/BioEngen/MA330_11/product/2DGround.csv");
  std::string line;
  ...
  //int j = 0;
  FILE *fp;
  fp=fopen("/home/kei/document/experiments/BioEngen/MA330_11/product/3DGround.csv","w");
  cv::Mat depthtest ;
  cv::Mat depthMat ;
  //depth画像を読み込む
