...
int main()
{
  ...
  while(true){
    ...
    rgbtest = cv::imread( "/home/kei/document/experiments/2019.06.25/data3/color/" + oss.str() + ".jpg" );
    printf("%d\n", rgbtest.type());
    ...
    //depthtest =  cv::imread( "/home/kei/document/experiments/2019.02.02/motion/1.squat/depth/" + oss.str() + ".tiff",2);
    ...
    cv::imwrite("/home/kei/document/experiments/2019.06.25/data3/regi/" + oss.str() + ".jpg",rgbd);
    //rgbd2 = rgbd2 / 256.0f;
