...
int main()
{
  ...
  while(true){
    ...
    depthtest =  cv::imread( "/home/shoda/Documents/mitsu/depth_fixed/" + oss.str() + ".tiff", 2);
    // depthtest =  cv::imread( "/home/shoda/Documents/Image_processing/pycode/0000000001_fixed.tiff", 2);
    ...
    cv::imwrite("/home/shoda/Documents/mitsu/regi_fixed/" + oss.str() + ".jpg",rgbd);
