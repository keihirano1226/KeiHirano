...
int main()
{
  ...
  while(true){
    ...
    rgbtest = cv::imread( "/home/kei/document/experiments/BioEngen/MA336_4/color2/" + oss.str() + ".jpg" );
    printf("%d\n", rgbtest.type());
    ...
    depthtest =  cv::imread( "/home/kei/document/experiments/BioEngen/MA336_4/depth/" + oss.str() + ".png",2);
    ...
    cv::imwrite("/home/kei/document/experiments/BioEngen/MA336_4/regi2/" + oss.str() + ".jpg",rgbd);
    //rgbd2 = rgbd2 / 256.0f;
