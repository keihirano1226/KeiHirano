...
int main()
{
  ...
  while(true){
    ...
    rgbtest = cv::imread( "/home/kei/document/experiments/BioEngen/PI09_1/color/" + oss.str() + ".jpg" );
    printf("%d\n", rgbtest.type());
    ...
    //depthtest =  cv::imread( "/home/kei/document/experiments/BioEngen/PI09_1/depth/" + oss.str() + ".png",2);
    ...
    cv::imwrite("/home/kei/document/experiments/BioEngen/PI09_1/regi/" + oss.str() + ".jpg",rgbd);
    //rgbd2 = rgbd2 / 256.0f;
