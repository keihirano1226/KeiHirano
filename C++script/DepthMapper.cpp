...
int main()
{
  ...
  while(true){
    ...
    rgbtest = cv::imread( "/home/shoda/Documents/MA330_11/color2/" + oss.str() + ".jpg" );
    ...
    depthtest =  cv::imread( "/home/shoda/Documents/MA330_11/depth/" + oss.str() + ".png",2);
    ...
    cv::imwrite("/home/shoda/Documents/MA330_11/regi2/" + oss.str() + ".jpg",rgbd);
