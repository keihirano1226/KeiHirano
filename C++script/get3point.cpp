...
int main()
{
  ...
  std::ifstream stream("/home/kei/document/experiments/2019.06.06/backwalk/Yaxis2D.csv");
  std::string line;
  ...
  FILE *fp;
  fp=fopen("/home/kei/document/experiments/2019.06.06/backwalk/Yaxis3D.csv","w");
  cv::Mat depthtest ;
  cv::Mat depthMat ;
  //depth画像を読み込む
