...
def detect_diff(pose_matrix,cnt):
    ...
    df = df[cnt:cnt+1]
    # print(df[map2openpose['SPINE_SHOULDER']].values)
    print(df.iloc[:, df.columns.str.startswith(map2openpose['SHOULDER_RIGHT'])].values[0])
    print(pose_dict['SHOULDER_RIGHT'])
