...
columns = ['LegRFlex','LegRAdd','LegRRot','LegRKnee','LegLFlex','LegLAdd','LegLRot','LegLKnee']
JointAngleData = pd.DataFrame(data = JointAngleMatrix, columns= columns,dtype='float')
