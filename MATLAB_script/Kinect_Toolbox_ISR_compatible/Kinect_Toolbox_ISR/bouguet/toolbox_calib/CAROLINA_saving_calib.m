...
%             save_namepos = [ 'Calib_Results' postfix];
%             cont = (exist([ save_namepos '.mat'])==2);
%         end;
%         copyfile(save_name,[save_namepos '.mat']);
%         disp(['Copying the current Calib_Results file to ' save_name '.mat']);
